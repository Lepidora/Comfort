...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Comfort Demo Installer\n"
      else:
        line="OutputBaseFilename=Comfort Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Comfort Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Comfort installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Comfort Demo installer\n"
     else:
       line="SetupWindowTitle=Comfort installer\n"
