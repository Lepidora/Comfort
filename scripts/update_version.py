...
def main():
  ...
  plistpath = scriptpath + "/resources/Comfort-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Comfort-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Comfort-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Comfort-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Comfort-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Comfort.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Comfort.iss",inplace=1):
